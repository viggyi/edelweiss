...
var index$2 = require('./index-C845Ti6K.js');
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!index.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-YcSftOMz.js'); }).then((module) => module.startTapClick(index.config));
                }
                if (index.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-CCJk5VgT.js'); }).then((module) => module.startStatusTap());
                }
                if (index.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-CPL2J8F-.js'); }).then((module) => module.startInputShims(index.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-C4rMJ5uI.js'); });
