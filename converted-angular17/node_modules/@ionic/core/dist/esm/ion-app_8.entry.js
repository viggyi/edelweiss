 ...
 */
import { r as registerInstance, e as config, f as printIonWarning, h, d as Host, g as getElement, c as createEvent, a as readTask, i as forceUpdate, w as writeTask, j as printIonError } from './index-IGIE5vDm.js';
...
import { i as inheritAriaAttributes, h as hasLazyBuild, c as componentOnReady, e as clamp, s as shallowEqualStringMap } from './helpers-Tl8jw6S2.js';
import { i as isRTL } from './dir-C53feagD.js';
import { c as createColorClasses, h as hostContext } from './theme-DiVJyqlX.js';
import { a as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-hW6eNZ3o.js';
import { c as createKeyboardController } from './keyboard-controller-BaaVITYt.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-CyxE1S_P.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { t as transition } from './index-B-hkiOUh.js';
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./index-BtUdxPjv.js').then((module) => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-BfJqFSLF.js').then((module) => module.startStatusTap());
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-BZBFwTQV.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
